  ...
  const renderProfile = () => {
    ...
    return (
      <View style={styles.profileContainer}>
        ...
        <Text style={[styles.title, { color: dark ? COLORS.secondaryWhite : COLORS.greyscale900 }]}>Ataberk Kizlier</Text>
        <Text style={[styles.subtitle, { color: dark ? COLORS.secondaryWhite : COLORS.greyscale900 }]}>testataberk@gmail.com</Text>
      </View>
    )
  }
  /**
